            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data M-Banking</h1>
                        
                    </div>
                    <?php
    include '../koneksi.php';
    $id = $_GET['id'];
    $data = mysqli_query($koneksi,"select * from m_banking where id='$id'");
    while($d = mysqli_fetch_array($data)){
        ?>

                 <div class="card-body">
                                                    <form method="POST" action="m-banking/edit-mbank.php">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3 mb-3 mb-sm-0"><label for="exampleFormControlInput1">No. Hp</label><input class="form-control form-control-solid" name="no_hp" id="exampleFormControlInput1" type="text" value="<?php echo $d['no_hp']; ?>" required></div>    
                                                            
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-4 mb-3 mb-sm-0"><label for="exampleFormControlInput1">Email</label><input class="form-control form-control-solid" name="email" id="exampleFormControlInput1" type="text" value="<?php echo $d['email']; ?>" required></div>     
                                                        </div>
